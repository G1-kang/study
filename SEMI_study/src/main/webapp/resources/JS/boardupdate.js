...
function urlToBase64(){
   let img = document.getElementsByClassName("input_img") //boardwrite.js에서 작성한 이미지클래스
               ...
               if(boardConfirm()){
                  ...
                  for(let i = 0; i<imgArr.length; i++){
                     ...
                     if(i == imgArr.length-1){
                        ...
                        let content = document.getElementsByName("sdubcontent")[0]
...
function boardConfirm(){
   console.log("유효성검사!!")
   var title = document.getElementById("sdbtitle").value
