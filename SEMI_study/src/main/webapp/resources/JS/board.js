function authorityChk(id, boardId, sdbseq){
   if(id === boardId){
      location.href='update.do?sdbseq=' + sdbseq
   } else {
      alert("글 수정 권한이 없습니다.")
   }
} 
...
function fileDownChk(){
   ...
   var sdbseq = document.getElementById("sdbseq").value
   if(checkbox[index].checked){
      let fileName = checkbox[index].value
      let path = "fileDown.do"
      let params = {fileName:fileName, sdbseq:sdbseq}
